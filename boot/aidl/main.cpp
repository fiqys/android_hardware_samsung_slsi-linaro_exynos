 ...
 */
#define LOG_TAG "android.hardware.boot-service.exynos"
...
int main(int, char* argv[]) {
    ...
    std::shared_ptr<BootControl> module = ndk::SharedRefBase::make<BootControl>();
    ...
    ALOGI("IBootControl AIDL service running...");
